...
export default function Softneo({ cv }) {
  const color = cv.theme?.primary_color || "#14b8a6";
  ...
  return (
    <div className="cv-page mx-auto" style={{ fontFamily: font, color: "#1a202c", background: "#f0fdfa" }}>
      <div className="m-8 rounded-3xl p-8 text-white" style={{ background: `linear-gradient(135deg, ${color}, #2dd4bf)` }}>
